...
servicos.each do |key,elm|
    ...
    resumo[key] = {nome: elm["nome"],sigla:elm["sigla"],orgao:elm["orgao"]["nomeOrgao"], id_orgao: elm["orgao"]["id"].gsub("http://estruturaorganizacional.dados.gov.br/id/unidade-organizacional/",""),contato:elm["contato"],gratuito?:elm["gratuito"],porcentagem_digital:elm["porcentagemDigital"],serviço_digital?:elm["servicoDigital"],link_btn_iniciar:elm["linkServicoDigital"],avaliacoes_positivas: av["positivas"],avaliacoes_negativas: av["negativas"], descricao: elm["descricao"]}
    # ids << key
    nompop = []
